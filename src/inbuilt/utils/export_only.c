...
/*   Updated: 2022/06/20 18:20:03 by ehoundey         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
используется для чистого выхода с заданным статусом exit_status
*/
...
/*
перебирает все элементы env_var_cpy и сортирует их в порядке возрастания
*/
...
/*
выведет переменные с их значением так же, как это делает export
*/
...
/*
имитирует поведение вызова export без каких-либо аргументов
*/
