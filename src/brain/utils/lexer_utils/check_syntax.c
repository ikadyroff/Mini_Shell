...
/*   Updated: 2022/06/20 18:36:07 by ehoundey         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * Проверяет правильность синтаксиса лексем. 
 * *lex_toks[]: Токены для проверки синтаксиса
 * true при правильном синтаксисе, false при неправильном синтаксисе
 */
